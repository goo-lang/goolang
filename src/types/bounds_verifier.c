...
// symbolic_expression_free moved to src/types/symbolic_expression.c so that
// consumers needing only the destructor (e.g. dependent_types.c) don't have to
// link the whole bounds verifier / type checker. Prototype: panic_free.h.

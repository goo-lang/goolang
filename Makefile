...
# asks for.
ARENA_FREE_PROBE_NAMES = arena_reclaim_probe arena_escape_return_probe arena_escape_store_probe arena_embedded_escape_probe arena_loop_reclaim_probe arena_defer_escape_probe
...
arena-free-probe: $(COMPILER) $(RUNTIME_LIB)
	...
	echo "arena-free-probe: PASS (6/6)"
...
arena-valgrind-probe: $(COMPILER) $(RUNTIME_LIB)
	...
	echo "arena-valgrind-probe: PASS (6/6 clean)"

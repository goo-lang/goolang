...
## T1 — P2.1: enforce Go method-set rules in interface satisfaction
...
## T2 — P2.2: Go-compatible nil for bare `*T` / `[]T` / `map[K]V` / `chan T` / `func`
...
## T3 — probes, characterization, truth pass
